...
class HeaderVoltep2 extends Component{
    constructor(props) {
        super(props);
    ...
    render(){
        ...
        if(logo === 'light'){
            ...
            logoUrl = <img src="/assets/images/logo/voltep-logo-white-x1.svg" alt="Digital Agency" />;
                ...
                <div className="header-wrapper">
                    <div className="header-left d-flex align-items-center">
                        ...
                        <nav className="mainmenunav d-lg-block ml--50">
                            <Scrollspy className="mainmenu" items={['home','about','service','projects','contacts']} currentClassName="is-current" offset={-200}>

                            ...
                            <div className="row row--35 align-items-center">
                                <div className="col-lg-5">
                                    <div className="thumbnail">
                                        <img className="w-100" src="/assets/images/about/about-vi-img-1.png" alt="About Images"/>
                                    </div>
                                </div>
                                <div className="col-lg-7">
                                    <div className="about-inner inner">
                                        <div className="section-title">
                                            <h2 className="title">Индивидуальность</h2>
                                            <p className="description">Масштабы и интерьер выставочных зон разрабатываются и настраиваются под требования и фирменный стиль Заказчика.</p>
                                            <p className="description">В павильонах выставки можно создать оригинальные интерьерные решения и визуализировать многоуровневые сцены.</p>
                                            <p className="description">Удивите посетителей не только наполнением выставки, но и футуристичным внешним видом!</p>
                                        </div>
